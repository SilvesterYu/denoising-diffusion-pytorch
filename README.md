...
(4) change `save_and_sample_every` in `denoising_diffusion_pytorch.py` according to need
...
```
pip install beautifulsoup4 defusedxml lxml cycler kiwisolver oauthlib six
```
---
